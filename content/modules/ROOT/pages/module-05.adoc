...
[source,bash]
----
oc -n dynamic-schedule patch deployment stress-test --merge -p '{"spec":{"template":{"spec":{"nodeSelector":{"kubernetes.io/hostname":"worker01"}}}}}'
----
...
[source,bash]
----
oc -n dynamic-schedule scale deployment stress-test --replicas=1
----
...
[source,bash]
----
oc get pods -n dynamic-schedule
----
