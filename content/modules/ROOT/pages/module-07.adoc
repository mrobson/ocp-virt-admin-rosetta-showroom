...
Decentralized live migration is a variation of storage live migration that allows you to migrate a `VirtualMachine` between namespaces or between different clusters.
