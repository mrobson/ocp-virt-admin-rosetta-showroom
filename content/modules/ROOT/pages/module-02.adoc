...
[source,bash]
----
oc get vms -n overcommit -o custom-columns=\
...
[source,bash]
----
oc get vm overcommit-vm-1 -n overcommit -o jsonpath='{.spec.template.spec.domain.cpu.cores}{"\n"}'
----
...
[source,bash]
----
oc get vmi overcommit-vm-1 -n overcommit -o jsonpath='{.spec.domain.cpu}{"\n"}'
----
...
[source,bash]
----
oc get pods -n overcommit -l vm.kubevirt.io/name=overcommit-vm-1
----
...
[source,bash]
----
oc get pod -n overcommit <pod_name> \
