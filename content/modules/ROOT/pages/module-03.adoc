...
[start=4]
. Give the disk a name, if desired, and select the previously disconnected PVC name in the PersistentVolumeClaim name menu (e.g. dv-vm01-data-disk-01-um6O11)
