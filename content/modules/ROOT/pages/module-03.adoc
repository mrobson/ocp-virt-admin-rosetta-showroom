...
. Login to the OpenShift console using the credentials provided to you by the lab administrator. Navigate to Virtualization -> Virtual Machines, and select the $PROJECT project. Select the VM named $VMNAME .
