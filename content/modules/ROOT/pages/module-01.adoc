...
[start=5]
. Change the selection to Specific Node and then click on the node worker-cluster-s67qr-1.
...
[start=10]
. Once the migration is Complete, navigate back to the virtual machine called vm01 and view the Configuration -> Storage options again.
